...
class ActivityLogAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("User Information", {"fields": ("user", "ip_address", "user_agent")}),
        ("Action Details", {"fields": ("action", "timestamp")}),
        ("Model Information", {"fields": ("model_name", "object_id", "object_repr")}),
        (
            "Changes",
            {"fields": ("changed_fields", "description"), "classes": ("collapse",)},
        ),
        ("Sensitivity", {"fields": ("is_sensitive",)}),
    )
