        ...
        categories_data = [
            {
                "name": "Personnel",
                "color": "#3498db",
                "description": "Personnel and salary expenses",
            },
            {
                "name": "Operations",
                "color": "#2ecc71",
    ...
    def _create_fund_sources(self):
        ...
        for data in fund_sources_data:
            fs, created = FundSource.objects.get_or_create(
                name=data["name"], defaults={"annual_budget": data["annual_budget"]}
            )
            if created:
        ...
        for bank_account in bank_accounts:
            ...
            transactions_data = [
                ...
                },
                {
                    ...
                    "check_number": "CHK-0004",
                },
                {
                    "date_offset": 23,
                    "description": "Contract payment",
                    "debit": Decimal("75000.00"),
                    "check_number": "CHK-0005",
                },
                {
                    "date_offset": 22,
            ...
            for trans in transactions_data:
                ...
                statement, created = BankStatement.objects.get_or_create(
                    ...
                    defaults={
                        ...
                        "status": (
                            "Cleared" if trans["date_offset"] > 15 else "On Process"
                        ),
                    },
                )
            ...
            monitoring, created = MasterFundMonitoring.objects.get_or_create(
                ...
                defaults={
                    ...
                    "purchase_type": purchase_types[
                        random.randint(0, len(purchase_types) - 1)
                    ],
                    "account_title": objects[random.randint(0, len(objects) - 1)],
                    "expense_classification": categories[
