...
class MasterFundMonitoringForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'goods_5_percent': forms.NumberInput(attrs={'class': 'form-control has-prefix-text', 'step': '0.01', 'min': '0', 'readonly': True}),
            'services_5_percent': forms.NumberInput(attrs={'class': 'form-control has-prefix-text', 'step': '0.01', 'min': '0', 'readonly': True}),
            'goods_services_3_percent': forms.NumberInput(attrs={'class': 'form-control has-prefix-text', 'step': '0.01', 'min': '0', 'readonly': True}),
            'goods_1_percent': forms.NumberInput(attrs={'class': 'form-control has-prefix-text', 'step': '0.01', 'min': '0', 'readonly': True}),
            'services_2_percent': forms.NumberInput(attrs={'class': 'form-control has-prefix-text', 'step': '0.01', 'min': '0', 'readonly': True}),
            'rental_5_percent': forms.NumberInput(attrs={'class': 'form-control has-prefix-text', 'step': '0.01', 'min': '0', 'readonly': True}),
            'prof_fee_10_percent': forms.NumberInput(attrs={'class': 'form-control has-prefix-text', 'step': '0.01', 'min': '0', 'readonly': True}),
            'goods_5_percent_2': forms.NumberInput(attrs={'class': 'form-control has-prefix-text', 'step': '0.01', 'min': '0', 'readonly': True}),
            'services_5_percent_2': forms.NumberInput(attrs={'class': 'form-control has-prefix-text', 'step': '0.01', 'min': '0', 'readonly': True}),
            'goods_services_1_percent': forms.NumberInput(attrs={'class': 'form-control has-prefix-text', 'step': '0.01', 'min': '0', 'readonly': True}),
            'goods_1_percent_2': forms.NumberInput(attrs={'class': 'form-control has-prefix-text', 'step': '0.01', 'min': '0', 'readonly': True}),
            'services_2_percent_2': forms.NumberInput(attrs={'class': 'form-control has-prefix-text', 'step': '0.01', 'min': '0', 'readonly': True}),
            'rental_5_percent_2': forms.NumberInput(attrs={'class': 'form-control has-prefix-text', 'step': '0.01', 'min': '0', 'readonly': True}),
            'prof_fee_10_percent_2': forms.NumberInput(attrs={'class': 'form-control has-prefix-text', 'step': '0.01', 'min': '0', 'readonly': True}),
        }
    ...
    def clean_dv_number(self):
        ...
        try:
            ...
            raise ValidationError('DV number must contain only letters, numbers, and hyphens.', code='invalid_format')
        return dv_number
    ...
    def clean_cheque_number(self):
        ...
        try:
            ...
            raise ValidationError('Cheque number must contain only letters, numbers, and hyphens.', code='invalid_format')
    ...
    def clean(self):
        ...
        if mooe and payments and transaction_type in ['Disbursement', 'Downloads']:
            ...
            mooe_budget = FundSourceBreakdown.objects.filter(category__code=mooe_code).aggregate(total=Sum('budget_amount'))['total'] or Decimal(0)
            mooe_disbursed = MasterFundMonitoring.objects.filter(mooe=mooe_code, transaction_type__in=['Disbursement', 'Downloads']).aggregate(total=Sum('payments'))['total'] or Decimal(0)
            mooe_refunded = MasterFundMonitoring.objects.filter(mooe=mooe_code, transaction_type='Refund').aggregate(total=Sum('payments'))['total'] or Decimal(0)
